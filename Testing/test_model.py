...
'''
package_folder=Model.get_model_path()
...
models_in_package = ["Modelica.Fluid.Examples.PumpingSystem"]
...
gen.generate_tests(test_folder=this_folder / "gen_tests", test_name="BlocksAbsDistPtwise_from_script",
                   ...
                   references={"Modelica.Fluid.Examples.PumpingSystem": str(this_folder / "references/reference_PumpingSystem.csv")})
